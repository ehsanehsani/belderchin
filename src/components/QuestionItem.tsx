...
import type { Question, QuestionResult } from '../types/Course'
...
const QuestionItem = ({ question, questionNumber, result, onAnswerSelect }: QuestionItemProps) => {
  const [selectedValue, setSelectedValue] = useState(result?.selectedAnswer || '')
